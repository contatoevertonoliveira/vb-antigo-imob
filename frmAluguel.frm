...
Begin VB.Form frmAluguel 
   BorderStyle     =   3  'Fixed Dialog
   Caption         =   "Super Imob - Relação de Aluguéis"
   ClientHeight    =   5505
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   11205
   ...
   Begin MSDBGrid.DBGrid DBGrid1 
      Bindings        =   "frmAluguel.frx":0000
      Height          =   3135
      Left            =   120
      OleObjectBlob   =   "frmAluguel.frx":0014
      TabIndex        =   8
      Top             =   840
      Width           =   10935
   End
   ...
   Begin VB.ComboBox Combo1 
      ...
      EndProperty
      Height          =   360
      ItemData        =   "frmAluguel.frx":173F
      Left            =   8040
      List            =   "frmAluguel.frx":1741
      TabIndex        =   6
      Text            =   "Selecione..."
      Top             =   4920
      Width           =   2415
...
If Option1.Value = True Then
    ...
    Data1.RecordSource = "SELECT * FROM Vencimentos WHERE Codigo Like '" & Text1.Text & "*'"
    Data1.Refresh
...
ElseIf Option2.Value = True Then
    ...
    Data1.RecordSource = "SELECT * FROM Vencimentos WHERE Locador Like '" & Text1.Text & "*'"
    Data1.Refresh
...
ElseIf Option3.Value = True Then
    ...
    Data1.RecordSource = "SELECT * FROM Vencimentos WHERE Locatario Like '" & Text1.Text & "*'"
    Data1.Refresh
End If
End Sub
